...
import { Calendar, Mail, FileSearch, MessageSquare } from "lucide-react";
    ...
    <div className="min-h-screen">
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 py-12 relative overflow-hidden">
        ...
        <p className="text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto mb-8 text-muted-foreground px-2 animate-fade-in" style={{ animationDelay: '0.5s', animationDuration: '0.8s', animationFillMode: 'both' }}>
          We're excited to help you achieve your credit goals.
        </p>
        ...
        {loading ? (
          <div className="flex justify-center mb-12 animate-fade-in" style={{ animationDelay: '0.7s', animationDuration: '0.8s', animationFillMode: 'both' }}>
            <div className="w-full max-w-sm h-96 bg-card rounded-2xl shadow-lg animate-pulse" />
          </div>
        ) : payment ? (
          <div className="flex justify-center mb-12 animate-fade-in" style={{ animationDelay: '0.7s', animationDuration: '0.8s', animationFillMode: 'both' }}>
            <AnimatedTicket
