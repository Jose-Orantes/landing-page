...
const bannerVariants = cva(
	'relative overflow-hidden rounded-md border shadow-sm text-sm',
	{
		variants: {
			variant: {
				...
				info: 'bg-blue-50 border-[#057bff] text-blue-900 dark:bg-blue-900/20 dark:border-[#057bff] dark:text-blue-100',
				premium:
